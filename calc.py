# The file is aimed at developing a calculator based on voice input translated to text
from os import system
import re



# This snippet of code has been taken from the webpage
# http://code.activestate.com/recipes/550818-words-to-numbers-english/
# The code is under Python Software Foundation Licence
